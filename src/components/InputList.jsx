  ...
  return (
        ...
        <>
            ...
            <div className="flex flex-wrap gap-2">
                ...
                <div
                    key={index}
                    className="group flex items-center gap-2 bg-turquoise-200 text-turquoise-700 px-3 py-1.5 rounded-full transition-all duration-200 hover:bg-turquoise-400"
                >
