    ...
    return (
        ...
        >
            <div className="flex items-center space-x-4 mb-3 sm:mb-0">
                <div
                    onClick={onToggle}
                    className={`w-5 h-5 rounded border cursor-pointer flex items-center justify-center transition-colors ${isSelected ? 'bg-turquoise-500 border-turquoise-500' : 'border-gray-300 hover:border-turquoise-400'
                        }`}
                >
