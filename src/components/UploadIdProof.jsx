...
function UploadIdProof({ idProofData, uploadModalOpen = false, isUploadModalOpen = false, closeUploadModal }) {
    ...
    if (file) {
      ...
      try {
        ...
        if (response?.success) {
          ...
          localStorage.setItem("user", JSON.stringify({ ...authState, isIdUploaded: true }));
          dispatch(setAuth());
  ...
  return (
    <div className="min-h-screen  py-6">
      <div className="mx-auto space-y-6">
        {/* Disclaimer Section */}
        {!uploadModalOpen && isIdProofMandatory && disclaimerText && (
