...
export default function Rides() {
    ...
    } = useApi(adminService.adminRidesAdd);
    ...
    } = useApi(adminService.adminGetAllRides);
    ...
    } = useApi(adminService.adminRidesEdit);
    ...
    const getDescription = () => {
        if (!isEditing) {
            return "Add rides & drives details. Click submit when you're done";
        } else {
            return "Edit the rides & drives details. Click submit when you're done";
        }
    };
    ...
    return (
        <>
          ...
          Amenities Management
                ...
                <Button onClick={() => setIsModalOpen(true)} size="sm"><CirclePlus className='pr-1 pb-1' color="#ffffff" />Add Rides</Button>
                <Modal
                    isOpen={isModalOpen}
                    onClose={handleClose}
                    title={getTitle()}
            ...
            <div className="min-h-screen my-4">
                {
                    allAmenities?.data.length > 0 ? (
                        <Table
                            title="Rides & Drives Management"
                            subtitle="Manage your Rides & Drives"
