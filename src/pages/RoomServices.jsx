...
export default function RoomServices() {
    ...
    } = useApi(adminService.adminRoomserviceAdd);
    ...
    } = useApi(adminService.adminGetAllRoomservice);
    ...
    } = useApi(adminService.adminRoomserviceEdit);
            ...
            <div className="min-h-screen my-4">
                {
                    allAmenities?.data.length > 0 ? (
                        <Table
                            ...
                            subtitle="Manage your room service"
