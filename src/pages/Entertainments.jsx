...
export default function Entertainments() {
    ...
    } = useApi(adminService.adminEntertainmentAdd);
    ...
    } = useApi(adminService.adminGetAllEntertainment);
    ...
    } = useApi(adminService.adminEditEntertainment);
            ...
            <div className="min-h-screen my-4">
                {
                    allAmenities?.data.length > 0 ? (
                        <Table
                            ...
                            subtitle="Manage your entertainment services"
